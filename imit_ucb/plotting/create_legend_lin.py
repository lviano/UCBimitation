...
labels = ["FRA (Ours)", "PPIL","IQLearn", "OPTAIL", "ILARL"]
colors = ["red", "green",
            "goldenrod",
            "brown","blue"]
...
plt.tight_layout()
plt.savefig("figs/legend_lin.pdf")
...
lines.append(ax.plot(range(2), range(2), '-o', c=colors[3])[0])
lines.append(ax.plot(range(2), range(2), '-o', c=colors[4])[0])
fig_legend.legend(lines, labels, loc='center', frameon=True, ncol=5)
plt.savefig("figs/legend_horizontal_lin.pdf")